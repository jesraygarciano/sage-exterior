...
function register_example_cpt() {
    ...
    $labels = array(
        'name'               => __('Sotorie Products', 'sage'),
        'singular_name'      => __('Sotorie Products', 'sage'),
        'add_new'            => __('Add New Sotorie Product', 'sage'),
        'add_new_item'       => __('Add New Sotorie Product', 'sage'),
        'edit_item'          => __('Edit Sotorie Product', 'sage'),
        'new_item'           => __('New Sotorie products', 'sage'),
        'view_item'          => __('View Sotorie products', 'sage'),
        'search_items'       => __('Search Sotorie products', 'sage'),
        'not_found'          => __('No Sotorie product found', 'sage'),
        'not_found_in_trash' => __('No Sotorie product found in Trash', 'sage'),
        'parent_item_colon'  => __('Parent Sotorie product type:', 'sage'),
        'menu_name'          => __('Sotorie Products', 'sage'),
    );
